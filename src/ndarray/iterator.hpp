...
public:
    ...
    reference operator*() const { return view_->view(idx_); }
    reference operator[](difference_type n) const 
        { return view_->view(idx_ + n); }

    auto& operator++() { ++idx_; return *this; }
    auto& operator--() { --idx_; return *this; }
    auto& operator++(int) { auto tmp = *this; ++idx_; return tmp; }
    auto& operator--(int) { auto tmp = *this; --idx_; return tmp; }

    auto& operator+=(difference_type n) { idx_ += n; return *this; }
    auto& operator-=(difference_type n) { idx_ -= n; return *this; }
    ...
    inline auto index() const { return idx_; }
